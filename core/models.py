...
class JobCreate(BaseModel):
    ...
    priority: Optional[int] = Field(default=0, description="Job priority (higher = more important)")
...
class ProfilingResultResponse(BaseModel):
    ...
    iterations: int
    parameters: Optional[Dict[str, Any]]
    result_metadata: Optional[Dict[str, Any]]  # Renamed from metadata
    timestamp: datetime
...
class WorkerNodeResponse(BaseModel):
    ...
    created_at: datetime
    worker_metadata: Optional[Dict[str, Any]]  # Renamed from metadata
