...
def main():
    ...
    docker_cmd = [
        ...
        "dprofiler-postgres",
        "-e",
        "POSTGRES_DB=dprofiler",
        "-e",
        "POSTGRES_USER=dprofiler",
        "-e",
    ...
    try:
        ...
        try:
            subprocess.run(
                ["docker", "stop", "dprofiler-redis"], check=True, capture_output=True
            )
            subprocess.run(
                ["docker", "stop", "dprofiler-postgres"],
                check=True,
                capture_output=True,
            )
